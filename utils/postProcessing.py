...
def memoryLogAssem(schedule, obs_mem_size, pro_mem_size, obs_rate, pro_rate, down_rate):
    ...
    for s in all_shifts:
        ...
        # for observation
        num_log[0][s] = num[0]/obs_rate
        mem_log[0][s] = num_log[0][s] * obs_mem_size
        
        # for processing
        num_log[1][s] = num[1]/obs_rate
        mem_log[1][s] = num_log[1][s] * pro_mem_size
        
        # for downlinking
        
        num_log[2][s] = num[2]/obs_rate
