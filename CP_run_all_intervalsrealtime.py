...
for interval in all_interval:
    ...
    (model, shifts, target_ilum, num_obs, num_pro, num_down, memory, Log) = CPModel_SC_realtime_process(any_ilum_list,gnd_stat_list, interval_size_CP_model,b, obs_dataset_mem, obs_rate, pro_dataset_mem,
